...
func Test_AclApp_Subscribe(t *testing.T) {
	...
	t.Run("top_onchange", func(t *testing.T) {
		tv := testTranslateSubscribeForMode(t, "/openconfig-acl:acl", OnChange)
		tv.VerifyCount(translErr, 0)
	})

	t.Run("top_targetdefined", func(t *testing.T) {
		tv := testTranslateSubscribeForMode(t, "/openconfig-acl:acl", TargetDefined)
		tv.VerifyCount(2, 1)
